<!DOCTYPE html>
<html xmlns:og="http://opengraphprotocol.org/schema/" data-wf-page="6775a4946057800443f76668" lang="ru-RU">

<head>
  <!-- Default meta tags -->
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <title>Контакты | statement™ - стильная фотостудия в центре Санкт-Петербурга</title>
        ...
        <div class="heading-contact">
          ...
          <div class="hide">
            <h1 data-w-id="918205aa-520f-066c-c1f0-c46c1c02b7a5"
              style="-webkit-transform:translate3d(0, 200%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 200%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 200%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 200%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)"
              class="text-dark-32">Свяжитесь с нами</h1>
          </div>
        </div>
      </div>
      ...
      <div class="w-layout-grid contact-halves">
        <div id="w-node-c6e35a31-fec2-c14b-2c9f-3bc5d2187d67-43f76668" class="contact-left">
          <div class="contact-info-block">
            ...
            <div class="contact-info-tile" style="grid-row-gap: 0px;">
              ...
              <div class="footer-socials">
                <div class="link-underline-hover"><a href="https://www.instagram.com/statement_st/" target="_blank"
                    class="text-big">Запрещёнограм*, </a>
                  <div class="link-under-line">
                    <div class="link-under-line-filled"></div>
                  </div>
                </div>
            ...
            <div class="contact-info-tile">
              <div class="label text-dark-64">(Email)</div>
            ...
            <div class="contact-info-tile">
              <div class="label text-dark-64">(Кликабельные адреса в Яндекс картах)</div>
